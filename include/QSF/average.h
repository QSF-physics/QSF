...
template <typename ... Args> struct CO_AVG : _CO_AVG<Args...>, _RBUFFER
{
	// static constexpr std::string_view name = "AVG_";
	// constexpr CO_AVG() : _CO_AVG<Args...>((Args::rep & ...)) {}
	// template<REP R, OPTIMS opt, typename Operator> inline double calc() const noexcept;
};

template <typename ... Args> struct IMMEDIATE_AVG : _CO_AVG<Args...>, _XBUFFER
{
	// static constexpr std::string_view name = "AVG_";
	// constexpr IMMEDIATE_AVG() : _CO_AVG<Args...>((Args::rep & ...)) {}
	template<REP R, OPTIMS opt, typename Operator> inline double calc() const noexcept;
};
