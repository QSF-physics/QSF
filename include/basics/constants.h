...
/// @brief Converts wavelength in nanometers to frequency in atomic units
/// @param lambda
/// @return frequency in atomic units
constexpr double lambda_to_omega(long double lambda) { return lambda2omega / lambda; }