...
inline double SegmentB(ind i, ind j, ind jat, ind il, ind ir) { return Rn(i, il, ir) ? PointB(j, jat) : 0; }
inline double SegmentBi2(ind i, ind j, ind jat, ind il, ind ir) { return Rn2(i, il, ir) ? PointB(j, jat) : 0; }
inline double SegmentBj2(ind i, ind j, ind jat, ind il, ind ir) { return Rn(i, il, ir) ? PointB2(j, jat) : 0; }
inline double SegmentBi2j2(ind i, ind j, ind jat, ind il, ind ir) { return Rn2(i, il, ir) ? PointB2(j, jat) : 0; }
